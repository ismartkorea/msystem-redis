...
router.post('/signupProcess', function(req, res) {
    ...
    conn.query('insert into c_inf_tbl(c_id, c_pwd, c_name, c_addr1, c_addr2, c_postno, c_email, c_sex, c_birth, c_jumin_no' +
        ...
        ', ?, ?, ?, ?, ?, ?, "500", "'+ randomString(16) +'", "assist", now(), "user", now(), "user")',
...
router.post('/edit', function(req, res) {
    ...
    var ss = req.session;
    conn.query('UPDATE c_inf_tbl SET c_pwd = HEX(AES_ENCRYPT(?,"jtlab")), c_name = ?,'
        ...
        [
            req.body.usrPwd, req.body.usrName, req.body.usrAddr1, req.body.usrAddr2, req.body.usrPostNo,
            ...
            req.body.usrInfoYn, req.body.usrType, req.body.usrAuthLvl, ss.usrName, ss.usrNo
        ],
        function(err, result) {
            if(err) {
                console.log('error : ', err.message);
