...
router.post('/send', function(req, res, next) {
    ...
    if(senderType == "M") {
        sender = 'Assist Pro < jtlab.tech2@gmail.com > ';
        senderName = '관리자';
        receiver = usrEmail;
        ...
        sender = usrEmail;
        senderName = usrName;
        receiver =  'Assist Pro < jtlab.tech2@gmail.com > ';
        receiverName = '관리자';
    }
    var title = "[JT-COMPANY] AssistPro 서비스 진행상태 알림 안내";
    // mail 콘텐츠 셋팅.
    var mailOptions = {
        from : sender,
        to : receiver,
...
var mailTemplete = function(title, fromEmail, toEmail, fromName, toName, content) {
    ...
    msg += content+"\n";
    msg += "========================================================================================================\n";
    msg += " Copyright by JT-COMPANY, Assist PRO\n";
    msg += "==========================================================================================================";
